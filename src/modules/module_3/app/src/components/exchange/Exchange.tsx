...
export const Exchange: React.FC = () => {
    ...
    const [exchangeValues, setExchangeValues] = React.useState(new Map(Object.entries(initialState)));
    ...
    return (
        <section className="exchange">
            ...
            <a rel="stylesheet" href="#" target="_blank" className="exchange__all-courses"> All courses
            </a>
